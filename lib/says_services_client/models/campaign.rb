...
module SaysServicesClient
  class Campaign < Models::Base
    ...
    attr_reader :friendly_id, :is_ended, :is_completed, :remaining_days, :total_available_reward, :per_uv_reward, :site_url, :photo_url, :large_photo_url, :site_screenshot_url, :triggers, :tag_list, :requirement, :country, :reward_count, :total_reward
